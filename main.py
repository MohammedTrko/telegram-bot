...
# --- إعداد خادم Flask لإبقاء الخدمة نشطة على Render ---
app = Flask('')
...
def start_cmd(message):
  ...
  text_response = f'أهلا بك يا {user_name}\n رصيدك/دينك هو {user_balance}'
...
def zero_cmd(message):
  ...
  if success:
    bot.reply_to(message, 'لقد تم تصفير حسابك')
  else:
